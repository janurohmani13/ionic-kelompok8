...
},
{
  ...
  {
    path: 'courierforgot-password',
    loadComponent: () => import('./courier/forgot-password/forgot-password.page').then(m => m.ForgotPasswordPage),
  },
  {
    path: 'verify',
    loadComponent: () => import('./courier/verify/verify.page').then(m => m.VerifyPage),
  },
  {
  ...
  {
    path: 'detail',
    loadComponent: () => import('./courier/detail/detail.page').then( m => m.DetailPage)
  },
  {
    path: 'courierprofile',
